  ...
  try {
    const completion = await openai.chat.completions.create({
      messages: [
        ...
        {
          "role": "system", 
          "content": "JSON Format, no backticks, no 'json' keyword. Structure json like this: '{'topics': [{'topic': 'Intro', 'starting_sentence': 'example sentence.', 'notes': ['note 1', 'note 2']}]}'."
        },
        {
          "role": "user", 
          "content": transcript
